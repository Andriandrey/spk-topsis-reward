...
$database_koneksi = "skripsi";
$username_koneksi = "root";
$password_koneksi = "";
$koneksi = mysql_pconnect($hostname_koneksi, $username_koneksi, $password_koneksi) or trigger_error(mysql_error($koneksi), E_USER_ERROR);
...
$rs_login = mysql_query($query_rs_login, $koneksi) or die(mysql_error());
...
$rs_config = mysql_query($query_rs_config, $koneksi) or die(mysql_error());
...
$rs_tap = mysql_query($query_rs_tap, $koneksi) or die(mysql_error());
