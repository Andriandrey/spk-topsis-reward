...
<body class="skin-green fixed sidebar-mini sidebar-mini-expand-feature">
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1>
          Dashboard ::
          <small>Selamat Datang, <?= $nama; ?> SPK topsis Pemilihan karyawan terbaik pada erafone balaraja </small>
        </h1>
        <ol class="breadcrumb">
          ...
          <div class="col-xs-12">
            <div class="box">
              <div class="box-header">
                <h3 class="box-title"><a href="?page=home">MENU UTAMA</a></h3>
              </div>
              <!-- /.box-header -->
              <div class="box-body">
