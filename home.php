...
$rs_informasi = mysql_query($query_limit_rs_informasi, $koneksi) or die(mysql_error());
$row_rs_informasi = mysql_fetch_assoc($rs_informasi);

if (isset($_GET['totalRows_rs_informasi'])) {
  $totalRows_rs_informasi = $_GET['totalRows_rs_informasi'];
} else {
  $all_rs_informasi = mysql_query($query_rs_informasi);
  $totalRows_rs_informasi = mysql_num_rows($all_rs_informasi);
}
...
$rs_slider = mysql_query($query_limit_rs_slider, $koneksi) or die(mysql_error());
            ...
            <div class="box-body">
              <div class="box-group" id="accordion">
                ...
                <div class="panel box box-primary">
                  ...
                  <?php 
				  $no++;
				  } while ($row_rs_informasi = mysql_fetch_assoc($rs_informasi)); ?></div>
              ...
              <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                 ...
                 <?php 
				  ...
				  <?php 
				  $slide++;
				  } while ($row_rs_slider = mysql_fetch_assoc($rs_slider)); ?> 
