...
if (isset($_POST['ngapainpake'])) {
	...
	$LoginRS__query = sprintf(
		"SELECT Login, Password, Level FROM vw_login WHERE Login=%s AND Password=LEFT(PASSWORD(%s),10)",
	...
	if ($loginFoundUser) {
		...
		$insertSQL = sprintf(
			"INSERT INTO history_login (username_login, password_login, status_login, added_login) VALUES (%s, %s, %s, %s)",
			GetSQLValueString($loginUsername, "text"),
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-form-title" style="background-image: url(log_asset/images/erafone.jpg);">
