...
$rs_top = mysql_query($query_rs_top, $koneksi) or die(mysql_error());
$row_rs_top = mysql_fetch_assoc($rs_top);
$totalRows_rs_top = mysql_num_rows($rs_top);
?>
    ...
    <section class="content">       
          ...
          <div class="box box-success">
            ...
            <?php 
				...
				$rs_grafikB = mysql_query($query_rs_grafikB, $koneksi) or die(mysql_error());
				$row_rs_grafikB = mysql_fetch_assoc($rs_grafikB);
				$totalRows_rs_grafikB = mysql_num_rows($rs_grafikB);
...
<div class="col-md-4">
	...
	<table class="table table-bordered table-hover table-striped">
            ...
            <?php } while ($row_rs_top = mysql_fetch_assoc($rs_top)); ?>
     </table>
</div>
<div class="row"></div>
<?php
...
$rs_transaksi = mysql_query($query_rs_transaksi, $koneksi) or die(mysql_error());
$row_rs_transaksi = mysql_fetch_assoc($rs_transaksi);
$totalRows_rs_transaksi = mysql_num_rows($rs_transaksi);
  ?>
          ...
          <table class="table table-bordered table-hover table-striped">
            ...
            <?php } while ($row_rs_transaksi = mysql_fetch_assoc($rs_transaksi)); ?>
          </table>
          
  </div>     
    <?php } while ($row_rs_pos = mysql_fetch_assoc($rs_pos)); ?>
