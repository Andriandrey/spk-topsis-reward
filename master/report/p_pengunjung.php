...
$query_rs_pengunjung = sprintf("SELECT * FROM tb_pengunjung  INNER JOIN tb_pekerjaan ON pekerjaan_pengunjung = id_pekerjaan WHERE pekerjaan_pengunjung = %s AND ta_pengunjung = %s", 
	GetSQLValueString($colname_rs_pengunjung, "int"),
	GetSQLValueString($ta, "int"));
}else{
mysql_select_db($database_koneksi, $koneksi);
$query_rs_pengunjung = sprintf("SELECT * FROM tb_pengunjung  INNER JOIN tb_pekerjaan ON pekerjaan_pengunjung = id_pekerjaan WHERE ta_pengunjung = %s", GetSQLValueString($ta, "int"));
}
