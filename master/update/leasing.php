...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE tb_leasing SET nama_leasing=%s, alamat_leasing=%s, nohp_leasing=%s, active_leasing=%s WHERE id_leasing=%s",
                       GetSQLValueString($_POST['nama_leasing'], "text"),
                       GetSQLValueString($_POST['alamat_leasing'], "text"),
                       GetSQLValueString($_POST['nohp_leasing'], "text"),
                       GetSQLValueString($_POST['active_leasing'], "text"),
                       GetSQLValueString($_POST['id_leasing'], "int"));
...
mysql_select_db($database_koneksi, $koneksi);
$query_rs_leasing = sprintf("SELECT * FROM tb_leasing WHERE id_leasing = %s", GetSQLValueString($colname_rs_leasing, "int"));
$rs_leasing = mysql_query($query_rs_leasing, $koneksi) or die(mysql_error());
$row_rs_leasing = mysql_fetch_assoc($rs_leasing);
$totalRows_rs_leasing = mysql_num_rows($rs_leasing);
?>
