...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE tb_penerimaankas SET kode_penerimaankas=%s, tanggal_penerimaankas=%s, pembeli_penerimaankas=%s, diserahkan_penerimaankas=%s, uangmuka_penerimaankas=%s, kredit_penerimaankas=%s, statuspanjar_penerimaankas=%s, nominalpanjar_penerimaankas=%s, jenisbeli_penerimaankas=%s, leasing_penerimaankas=%s, transaksi_penerimaankas=%s, getmesin_penerimaankas=%s, periode_penerimaankas=%s, ut_penerimaankas=%s, ub_penerimaankas=%s, active_penerimaankas=%s WHERE id_penerimaankas=%s",
                       GetSQLValueString($_POST['kode_penerimaankas'], "text"),
                       GetSQLValueString($_POST['tanggal_penerimaankas'], "date"),
                       GetSQLValueString($_POST['pembeli_penerimaankas'], "text"),
                       GetSQLValueString($_POST['diserahkan_penerimaankas'], "int"),
                       GetSQLValueString($_POST['uangmuka_penerimaankas'], "double"),
                       GetSQLValueString($_POST['kredit_penerimaankas'], "double"),
                       GetSQLValueString($_POST['statuspanjar_penerimaankas'], "text"),
                       GetSQLValueString($_POST['nominalpanjar_penerimaankas'], "double"),
                       GetSQLValueString($_POST['jenisbeli_penerimaankas'], "text"),
                       GetSQLValueString($_POST['leasing_penerimaankas'], "int"),
                       GetSQLValueString($_POST['transaksi_penerimaankas'], "text"),
                       GetSQLValueString($_POST['getmesin_penerimaankas'], "text"),
                       GetSQLValueString($_POST['periode_penerimaankas'], "text"),
                       GetSQLValueString($_POST['ut_penerimaankas'], "date"),
                       GetSQLValueString($_POST['ub_penerimaankas'], "int"),
                       GetSQLValueString($_POST['active_penerimaankas'], "text"),
                       GetSQLValueString($_POST['id_penerimaankas'], "int"));
...
mysql_select_db($database_koneksi, $koneksi);
$query_rs_pk = sprintf("SELECT * FROM tb_penerimaankas WHERE id_penerimaankas = %s", GetSQLValueString($colname_rs_pk, "int"));
$rs_pk = mysql_query($query_rs_pk, $koneksi) or die(mysql_error());
$row_rs_pk = mysql_fetch_assoc($rs_pk);
$totalRows_rs_pk = mysql_num_rows($rs_pk);
?>
