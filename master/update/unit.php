...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE tb_unit SET smh_unit=%s, warna_unit=%s, kodewarna_unit=%s, mesin_unit=%s, rangka_unit=%s, tahun_unit=%s, statusmilik_unit=%s, status_unit=%s, tanggal_unit=%s, sales_unit=%s, supir_unit=%s, active_unit=%s WHERE id_unit=%s",
                       GetSQLValueString($_POST['smh_unit'], "int"),
                       GetSQLValueString($_POST['warna_unit'], "text"),
                       GetSQLValueString($_POST['kodewarna_unit'], "text"),
                       GetSQLValueString($_POST['mesin_unit'], "text"),
                       GetSQLValueString($_POST['rangka_unit'], "text"),
                       GetSQLValueString($_POST['tahun_unit'], "date"),
                       GetSQLValueString($_POST['statusmilik_unit'], "text"),
                       GetSQLValueString($_POST['status_unit'], "text"),
                       GetSQLValueString($_POST['tanggal_unit'], "date"),
                       GetSQLValueString($_POST['sales_unit'], "int"),
                       GetSQLValueString($_POST['supir_unit'], "int"),
                       GetSQLValueString($_POST['active_unit'], "text"),
...
mysql_select_db($database_koneksi, $koneksi);
$query_rs_unit = sprintf("SELECT * FROM tb_unit WHERE id_unit = %s", GetSQLValueString($colname_rs_unit, "int"));
